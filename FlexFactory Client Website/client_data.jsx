...
const CARD_IMG = (name) => `assets/cards/${name}?v=20260606`;

/* ---------------- Listings — Jobs (services / products to quote) ---------------- */
// badge tones: lime (FEATURED/NEW), blue (TOP), red (% OFF)
const JOBS = [
  { id: 'J-1', kind: 'job', title: '6-Layer PCB · HASL Finish', vendor: 'Circuit Guild', city: 'Dammam', rating: 5.0, reviews: 137, tags: ['PCB Fab', 'Multilayer'], cat: 'PCB Fab', icon: 'grid', image: CARD_IMG('Picture1.png'), badge: { l: 'FEATURED', t: 'lime' }, off: 25, featured: true, blurb: 'Turnkey multilayer fabrication with controlled-impedance stack-ups and 24-hour express options.' },
  { id: 'J-2', kind: 'job', title: 'FDM Print · PLA / PETG / ABS', vendor: 'Vertex Fabrication', city: 'Riyadh', rating: 5.0, reviews: 137, tags: ['3D Print', 'FDM'], cat: '3D Printing', icon: 'box', image: CARD_IMG('Picture2.png'), badge: { l: 'TOP #1', t: 'blue' }, off: 0, featured: true, blurb: 'Industrial FDM farm — up to 300×300×400 mm, fast turnaround on functional prototypes.' },
  { id: 'J-3', kind: 'job', title: 'Prototype PCB · Quick-turn', vendor: 'Circuit Guild', city: 'Dammam', rating: 5.0, reviews: 137, tags: ['PCB Fab', 'Multilayer'], cat: 'PCB Fab', icon: 'grid', image: CARD_IMG('Picture3.png'), badge: { l: 'FEATURED', t: 'lime' }, off: 7, featured: true, blurb: 'Bare boards in 48 hours. ENIG or HASL, soldermask in six colors.' },
  { id: 'J-4', kind: 'job', title: 'Bandsaw Cutting · Metal & Wood', vendor: 'Forge & Form', city: 'Riyadh', rating: 5.0, reviews: 137, tags: ['Cutting', 'Sheet'], cat: 'Laser', icon: 'tools', image: CARD_IMG('Picture4.png'), badge: { l: 'NEW', t: 'lime' }, off: 18, blurb: 'Precision stock cutting to length with deburring included.' },
  { id: 'J-5', kind: 'job', title: 'Resin (SLA) High-Detail Prints', vendor: 'Vertex Fabrication', city: 'Riyadh', rating: 5.0, reviews: 137, tags: ['3D Print', 'SLA'], cat: '3D Printing', icon: 'box', image: CARD_IMG('Picture5.png'), off: 0, blurb: '8K resin detail for miniatures, jewelry masters and dental.' },
  { id: 'J-6', kind: 'job', title: 'Flex PCB · Polyimide', vendor: 'Circuit Guild', city: 'Dammam', rating: 5.0, reviews: 137, tags: ['PCB Fab', 'Flex'], cat: 'PCB Fab', icon: 'grid', image: CARD_IMG('Picture6.png'), off: 7, blurb: 'Single and double-sided flex circuits with stiffeners.' },
  { id: 'J-7', kind: 'job', title: 'Laser Cut · Acrylic & Ply', vendor: 'Atlas Makerworks', city: 'Jeddah', rating: 5.0, reviews: 137, tags: ['Laser', 'Sheet'], cat: 'Laser', icon: 'layers', image: CARD_IMG('Picture7.png'), off: 0, blurb: 'CO₂ laser cutting and engraving up to 1200×900 mm beds.' },
  { id: 'J-8', kind: 'job', title: '5-Axis CNC Milling', vendor: 'Northgate Labs', city: 'Khobar', rating: 5.0, reviews: 137, tags: ['CNC', 'Aluminium'], cat: 'CNC', icon: 'tools', image: CARD_IMG('Picture8.png'), badge: { l: 'TOP #5', t: 'blue' }, off: 0, blurb: 'Tight-tolerance machined parts in aluminium, brass and POM.' },
  { id: 'J-9', kind: 'job', title: 'Bandsaw Cutting · Heavy Stock', vendor: 'Forge & Form', city: 'Riyadh', rating: 5.0, reviews: 137, tags: ['Cutting', 'Metal'], cat: 'Laser', icon: 'tools', image: CARD_IMG('Picture9.png'), off: 18, blurb: 'Horizontal bandsaw for bar and tube up to 250 mm.' },
  { id: 'J-10', kind: 'job', title: 'SMT Assembly · Reflow', vendor: 'Circuit Guild', city: 'Dammam', rating: 5.0, reviews: 137, tags: ['Assembly', 'SMT'], cat: 'PCB Fab', icon: 'grid', image: CARD_IMG('Picture10.png'), off: 0, blurb: 'Stencil, pick-and-place and reflow for small to medium runs.' },
  { id: 'J-11', kind: 'job', title: 'Anodizing & Finishing', vendor: 'Northgate Labs', city: 'Khobar', rating: 5.0, reviews: 137, tags: ['Finishing', 'Metal'], cat: 'CNC', icon: 'layers', image: CARD_IMG('Picture11.png'), off: 0, blurb: 'Type-II anodize in eight colours, bead-blast and passivation.' },
  { id: 'J-12', kind: 'job', title: 'Silicone & Resin Molding', vendor: 'Atlas Makerworks', city: 'Jeddah', rating: 5.0, reviews: 137, tags: ['Molding', 'Casting'], cat: 'Molding', icon: 'box', image: CARD_IMG('Picture12.png'), off: 0, blurb: 'Low-volume vacuum casting from your master or our print.' },
];

/* ---------------- Listings — Spaces (bookable desks / labs) ---------------- */
const SPACES = [
  { id: 'S-1', kind: 'space', title: 'Shared Workshop Bay', vendor: 'Forge & Form', city: 'Riyadh', rating: 5.0, reviews: 137, tags: ['Maker Space', 'Tools'], cat: 'Shop Floor Desk', icon: 'tools', image: CARD_IMG('Picture13.png'), badge: { l: 'FEATURED', t: 'lime' }, off: 30, featured: true, from: 86.25, blurb: 'Fully-equipped bay with rolling tool chest, bench and Wi-Fi.' },
  { id: 'S-2', kind: 'space', title: 'Electrical Desk · Bay 04', vendor: 'Northgate Labs', city: 'Riyadh', rating: 4.9, reviews: 127, tags: ['Electronics', 'ESD-safe'], cat: 'Electrical Desk', icon: 'grid', image: CARD_IMG('Picture14.png'), badge: { l: 'FEATURED', t: 'lime' }, sub: true, from: 25, blurb: 'ESD-safe electronics workbench with scope, supply and rework station.' },
  { id: 'S-3', kind: 'space', title: 'Wet Bench · Chemistry', vendor: 'Northgate Labs', city: 'Khobar', rating: 5.0, reviews: 137, tags: ['Lab', 'Ventilated'], cat: 'Wet Bench', icon: 'building', image: CARD_IMG('Picture15.png'), badge: { l: 'NEW', t: 'lime' }, off: 5, from: 86.25, blurb: 'Ventilated wet bench with fume extraction and PPE.' },
  { id: 'S-4', kind: 'space', title: 'Mechanical Desk · Assembly', vendor: 'Atlas Makerworks', city: 'Jeddah', rating: 5.0, reviews: 137, tags: ['Assembly', 'Bench'], cat: 'Mechanical Desk', icon: 'tools', image: CARD_IMG('Picture16.png'), badge: { l: 'NEW', t: 'lime' }, off: 10, from: 86.25, blurb: 'Heavy assembly bench with vice, press and air line.' },
  { id: 'S-5', kind: 'space', title: 'Photo / Product Studio', vendor: 'Vertex Fabrication', city: 'Riyadh', rating: 5.0, reviews: 137, tags: ['Studio', 'Lighting'], cat: 'Shop Floor Desk', icon: 'image', image: CARD_IMG('Picture17.png'), off: 0, from: 120, blurb: 'Lighting rig, backdrops and tripods for product shots.' },
  { id: 'S-6', kind: 'space', title: 'Resin Lab · Ventilated', vendor: 'Vertex Fabrication', city: 'Riyadh', rating: 5.0, reviews: 137, tags: ['Lab', 'UV Cure'], cat: 'Lab', icon: 'building', image: CARD_IMG('Picture18.png'), off: 0, from: 64, blurb: 'Resin printing lab with UV cure station and extraction.' },
  { id: 'S-7', kind: 'space', title: 'Electronics Lab · Bay 02', vendor: 'Northgate Labs', city: 'Khobar', rating: 5.0, reviews: 137, tags: ['Electronics', 'ESD-safe'], cat: 'Electrical Desk', icon: 'grid', image: CARD_IMG('Picture19.png'), off: 0, from: 28, blurb: 'Second ESD bay — same kit, quieter corner.' },
  { id: 'S-8', kind: 'space', title: 'CNC Operator Station', vendor: 'Northgate Labs', city: 'Khobar', rating: 5.0, reviews: 137, tags: ['CNC', 'Supervised'], cat: 'Mechanical Desk', icon: 'tools', image: CARD_IMG('Picture20.png'), off: 0, from: 96, blurb: 'Supervised access to a 3-axis mill with operator on call.' },
];
